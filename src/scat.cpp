...
"(replace, insert, delete, or text-based modifications) applied to one file.\n"
"\n"
"---\n"
"\n"
"## 1. Section structure\n"
...
"These commands search for an exact marker fragment in the file.\n"
"Marker may contain multiple lines. Everything before the first `---`\n"
"is treated as the marker, and everything after it is the inserted/replacement content.\n"
"\n"
"### Insert after text fragment\n"
"--- insert-after-text\n"
"<marker lines...>\n"
"---\n"
"<inserted lines...>\n"
...
"\n"
"## Recommended usage\n"
"* Prefer text-based commands (`*-text`) when possible — they are more stable\n"
"  and less sensitive to shifting line numbers.\n"
"* Always group modifications to multiple files into **one patch file**.\n";
}
